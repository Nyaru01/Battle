...
- `versionCode 58`, `versionName 0.58.0-alpha` ;
...
Après export, `tools/verify_apk.ps1` contrôle la scène principale, les dix-sept scripts d’exécution, les textures d’arène, les six atlas KayKit, les composants Kenney, les trois boutons fantasy originaux, les deux polices, l’architecture Arm64 et le budget de taille.
