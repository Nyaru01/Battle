...
- `Battle-0.10.0-universal-debug.apk` : armv7 et arm64, compatibilité maximale ;
- `Battle-0.10.0-arm64-debug.apk` : arm64 uniquement, taille réduite pour les appareils modernes.

Les deux paquets utilisent l'identifiant `com.nyaru01.battle`, `versionCode 10`, `versionName 0.10.0` et un SDK minimal Android 7.0 (API 24).
