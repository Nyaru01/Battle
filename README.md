...
Jeu mobile original de stratégie en arène, en temps réel et jouable hors ligne contre une IA. La v0.53 corrige le terrain et le placement : arène plein écran sans étirement, héros ancrés au sol et orientés, déploiement libre x/y dans toute la base alliée.
...
- 324 assertions automatisées, 1 000 combats IA reproductibles et profil local à 20 héros animés.
...
Configuration : `versionCode 53`, `versionName 0.53.0-alpha`, API 24 minimum, API cible 36, `arm64-v8a`, portrait, mode immersif et Vulkan Mobile. Android 10 ou plus récent est recommandé.
