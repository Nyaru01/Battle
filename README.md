...
Jeu mobile original de stratégie en arène, en temps réel et jouable hors ligne contre une IA. La v0.58 étend le langage fantasy bleu et métal forgé à tous les boutons de menu : actions, navigation, difficulté, collection, réglages, pause et résultat.

## Vertical slice 0.58

- six héros KayKit distincts, chacun avec 100 images : apparition, repos, marche, attaque, impact et défaite, de face et de dos ;
- accueil château plein écran avec profondeur illustrée, trio animé posé sur son estrade, HUD fantasy sculpté et famille complète de boutons originaux en métal et émail bleu ;
- contrôles texturés cohérents sur la navigation, la difficulté, la collection, les réglages, la pause et le résultat, avec variantes larges, compactes et carrées ;
...
- 349 assertions automatisées, 1 000 combats IA reproductibles et profil local à 20 héros animés.
...
Configuration : `versionCode 58`, `versionName 0.58.0-alpha`, API 24 minimum, API cible 36, `arm64-v8a`, portrait, mode immersif et Vulkan Mobile. Android 10 ou plus récent est recommandé.
