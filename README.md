...
Jeu mobile original de stratégie en arène, en temps réel et jouable hors ligne contre une IA. La v0.52 renforce le spectacle et la lisibilité : annonces d’arène animées, score clarifié, cartes prêtes mises en valeur et impacts de mêlée plus francs.
...
- 310 assertions automatisées, 1 000 combats IA reproductibles et profil local à 20 héros animés.
...
Configuration : `versionCode 52`, `versionName 0.52.0-alpha`, API 24 minimum, API cible 36, `arm64-v8a`, portrait, mode immersif et Vulkan Mobile. Android 10 ou plus récent est recommandé.
